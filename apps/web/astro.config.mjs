...
export default defineConfig({
  ...
  env: {
    schema: {
      ...
      OLLAMA_BASE_URL: envField.string({
        context: "server",
        access: "secret",
        default: "http://localhost:11434",
      }),
      OLLAMA_MODEL: envField.string({
        context: "server",
        access: "secret",
        default: "mistral:7b",
      }),
      BATCH_SIZE: envField.number({
        context: "server",
        access: "secret",
        default: 5,
      }),
      CHUNKER_BIN: envField.string({
        context: "server",
        access: "secret",
        optional: true,
      }),
      EXTRACTOR_BIN: envField.string({
        context: "server",
        access: "secret",
        optional: true,
      }),
      FIGURE_EXTRACT_BIN: envField.string({
        context: "server",
        access: "secret",
        optional: true,
      }),
