  ...
  return (
    <Show when={props.open}>
      ...
      >
        {/* Close button */}
        <button
          class="absolute right-4 top-4 z-71 rounded-full bg-black/50 p-2 text-white transition-colors hover:bg-black/70 cursor-pointer"
          onClick={(e) => {
            e.stopPropagation();
            handleClose();
          }}
